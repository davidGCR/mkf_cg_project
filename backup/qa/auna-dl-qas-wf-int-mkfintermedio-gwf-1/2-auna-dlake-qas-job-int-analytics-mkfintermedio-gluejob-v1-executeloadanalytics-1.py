...
df_afiliaciones = glueContext.create_dynamic_frame.from_options(
    ...
    connection_options={
        "paths": [
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/proy-gestion-cobranza/mkf_tablero_permanencia/"
        ],
        "recurse": True,
    },
)
...
df_afil.write.mode('overwrite') \
		        .format('parquet') \
		        .save('s3://auna-dlaqa-analytics-s3/structured-data/OLAP/pry-gestion-cobranza/mkf_tablero_permanencia/')