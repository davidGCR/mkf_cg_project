...
df_historica_activas = glueContext.create_dynamic_frame.from_options(
    ...
    connection_options={
        "paths": [
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/activas/IN_PORTAFOLIO_202111/2022/09/12/",
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/activas/IN_PORTAFOLIO_202112/2022/09/12/",
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/activas/IN_PORTAFOLIO_202201/2022/09/12/",
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/activas/IN_PORTAFOLIO_202202/2022/09/12/",
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/activas/IN_PORTAFOLIO_202203/2022/09/12/",
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/activas/IN_PORTAFOLIO_202204/2022/09/12/"
        ],
        "recurse": True,
    },
)
...
df_historica_bajas = glueContext.create_dynamic_frame.from_options(
    ...
    connection_options={
        "paths": [
            "s3://auna-dlaqa-stage-s3/structured-data/OLAP/pry-mop-fotos-poblacion-historica/bajas/2022/09/13/"
        ],
        "recurse": True,
    },
)
...
#Cambiar logica para abarcar desde el 202111 y agregar tambien la ruta de los periodos faltantes
...
#modificar esta linea y quitar los lit
...
#print(df_result_fields.show(10))
#df_result_fields.printSchema()

#guardado
df_result_fields.write.mode('overwrite') \
		        .format('parquet') \
		        .save('s3://auna-dlaqa-stage-s3/structured-data/OLAP/proy-gestion-cobranza/mkf_tablero_permanencia/')
